...
class MainLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # Add the home admin screen
        home_screen_admin = HomeScreenAdmin(name= "home_admin")
        self.screen_manager.add_widget(home_screen_admin)
        
        self.screen_manager.add_widget(login_screen)
        self.screen_manager.add_widget(home_screen_admin)
    
    def show_home_screen_admin(self):
        self.screen_manager.transition.direction = "right"
